...
class UserRegistrationForm(forms.UserCreationForm):
    ...
    error_messages = forms.UserCreationForm.error_messages.update(
        {
            "duplicate_username": _("Username telah digunakan.")
        }
    )
...
UserProfileSocialLinkFormSet = inlineformset_factory(
    CommonUserProfile, SocialLink, fields=('media_name', 'url'), extra=5, max_num=5)
